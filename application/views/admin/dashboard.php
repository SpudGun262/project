...
<div>
    ...
    <div class="row">
        <h3>Students Interested in Project Proposal</h3>
        <?php
        if (!empty($expires)) {
            echo '<table class="column">
                    <thead>
...

        {
            ...
            echo '<p data-alert class="alert-box secondary radius">No one is interested in any project you have posted. <a href="'.base_url('admin/proposals').'">Try posting another or edit an existing one</a></p>';
