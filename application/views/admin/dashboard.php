            ...
            foreach ($expires as $expire) {
                echo '<tr>';
                    ...
                    echo '<div id="myModal' . $expire['project_id'] . '" class="reveal-modal" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">';
                        ...
                        echo '<a href="' . base_url('admin/projects/deleteExpiredProject') . '/' . $expire['project_id'] . '" class="alert radius button small right">Confirm delete</a>';
                    ...
                    echo '<div id="myModal' . str_replace(' ', '', $expire['title']) . '" class="reveal-modal" data-reveal aria-labelledby="modalTitle" aria-hidden="true" role="dialog">';
                        ...
                        echo '<a href="' . base_url('admin/projects/extendProject') . '/' . $expire['project_id'] . '" class="radius button small right">Confirm Extend</a>';
                        echo '<a class="close secondary radius button small" aria-label="Close">Cancel</a>';
                        echo '<a class="close-reveal-modal" aria-label="Close">&#215;</a>';
                    echo '</div>';
                echo '</tr>';
