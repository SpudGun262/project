        ...
        <form data-abide action="" method="post" enctype="multipart/form-data">
            ...
            <div class="name-field">
                <label>Project Title
                    ...
                    <input type="text" id="project_title" name="project_title" value="<?= $projectResult['title'] ?>"
                           required pattern="[a-z\d\-_\s]+$">
                </label>
            ...
            <div class="name-field">
                <label>Abstract
                    ...
                    <textarea id="abstract" name="abstract" required><?= $projectResult['abstract'] ?></textarea>
                </label>
            ...
            <input type="submit" name="edit_project" value="Edit Project" class="button radius"> <a
