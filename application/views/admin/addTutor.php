        ...
        <form data-abide action="<?=base_url('admin/tutors/addTutor') ?>" method="post">
            ...
            <div class="name-field">
                <label>Research Interest <small id="characterLimit" class="right">100 Characters Left</small>
                    <input id="researchInterest" type="text" name="research_interest" value="<?=set_value('research_interest');?>" placeholder="Add the research interest of the tutor">
                </label>
            </div>
            ...
            $("#helpAndAdvice").replaceWith(
                '<div id="helpAndAdvice" class="panel callout">' +
                    ...
                    '<div id="helpText">' +
                        ...
                        '<p>Make sure it is secure and not easy to guess.</p>' +
