        ...
        <form data-abide method="post">
            ...
            <div class="name-field">
                <label>Proposal Title <small>required</small>
                    ...
                    <input type="text" id="proposal_title" name="proposal_title" value="<?=$proposalResult['title']?>" placeholder="Add the proposal title" required pattern="[a-z\d\-_\s]+$">
                </label>
            ...
            <div class="name-field">
                <label>Description <small>required</small>
                    ...
                    <textarea id="desc" name="desc" required><?=$proposalResult['desc']?></textarea>
                </label>
            ...
            <input type="submit" name="edit_proposal" value="Edit Proposal" class="button radius"> <a class="button radius secondary" href="<?=base_url('admin/proposals')?>">Cancel</a>
